      ...
      >
        <input
          ...
          style={{
            cursor: "pointer",
            outline: "none",
            height: "10px", // Keep this the same for the circular shape
            width: "10px", // Set width to match the height for a perfect circle
            backgroundColor: itemsValues?.colored ? "red" : "rgb(48, 45, 45)",
