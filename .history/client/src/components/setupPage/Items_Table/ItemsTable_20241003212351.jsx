  ...
  return (
    <>
      ...
      >
        <input
          id="colored"
          className="input_show_item colored-circle"
          style={{
            cursor: "pointer",
            outline: "none",
            height: "5px", // Keep this the same for the circular shape
            width: "5px", // Set width to match the height for a perfect circle
            backgroundColor: itemsValues?.colored ? "red" : "none",
            borderRadius: "50%", // This makes the element a circle
            boxShadow:itemsValues?.colored ?  "0px 4px 6px rgba(0, 0, 0, 0.2)" : "none", // Adds a subtle shadow
            borderColor: itemsValues?.colored ? "red" : "transparent",
          }}
